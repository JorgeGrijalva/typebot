...
description: "Learn how to add a chatbot to Webflow easily. Boost engagement with AI-powered interactions, step-by-step integration guide, and customizable templates. Transform your site today!"
postedAt: "2024-09-25"
author: younes
---
...
This guide will walk you through integrating Norobot, a versatile chatbot builder, into your Webflow site. Whether you want a subtle chat bubble or a full-screen conversational experience, we've got you covered.

## Integrating Norobot with Webflow

<Image
  src="/blog-assets/add-chatbot-to-webflow/different-ways-to-integrate-chatbot.jpg"
  alt="Different Ways To Integrate a Chatbot"
  width={1018}
  height={591}
/>
Norobot offers flexibility in enhancing your Webflow site with conversational capabilities.
You have three distinct integration methods:

- **Standard Integration**: Embed Norobot directly into a container on your Webflow page. This approach makes the chatbot a prominent, always-visible feature. It’s perfect for dedicated landing pages or support sections where immediate engagement is crucial.
...
## Step-by-Step Guide to Embedding Norobot in Webflow

Integrating Norobot into your Webflow site starts in your Norobot dashboard. Navigate to the 'Share' tab of your bot here. You'll find all the necessary information for embedding your chatbot across various platforms, including Webflow.
...
Norobot's instructions involve copying a snippet of code and pasting it into the appropriate section of your Webflow project. This code snippet brings your Norobot to life on your Webflow pages.
...
2. In the top navigation bar, click on "Settings" You can access them directly from your dashboard as well:
   ...
   <Image
     src="/blog-assets/add-chatbot-to-webflow/webflow-site-settings.jpg"
...
3. In the left sidebar of the Settings page, select "Custom Code"
   ...
   <Image
     src="/blog-assets/add-chatbot-to-webflow/webflow-custom-code-section.jpg"
...
5. Copy the code snippet provided by Norobot for your chosen integration method (standard embed, bubble, or popup).
...
By following these steps, you can easily add custom code for your Norobot chatbot to your Webflow site, regardless of your technical expertise.

<Cta />

### Customizing Your Norobot Integration

After pasting the embed code, you're not limited to a default appearance. **Norobot offers various customization options within the Webflow interface**. You can adjust the size, position, and trigger events for your chatbot. This ensures it aligns perfectly with your site's design and user experience goals.

### Testing Your Integration

Before publishing your updated Webflow site, thoroughly test the Norobot integration. Preview your site and interact with the chatbot as a visitor would. This step helps you catch any potential issues and ensures the bot functions as intended across different devices and screen sizes.

<Info>
  If you're looking to add a popup contact form to your Webflow site, check out
  this [guide on adding a popup contact form with Norobot](./webflow-popup-contact-form.mdx).
</Info>

## Advanced Customization Options

Norobot's integration with Webflow offers advanced customization options. These features let you control how and when your chatbot interacts with visitors, boosting engagement and conversion rates.

### Triggering Norobot Commands on Button Clicks

You can trigger specific Norobot commands when a user clicks a button on your Webflow site. This feature allows seamless blending of your site's design with interactive chatbot functionality.

**To implement this:**

1. Assign a unique ID to the button you want to use as a trigger in the Settings tab of your button element in Webflow.
2. Modify the Norobot embed script to include an event listener for the button click.

Example script:

```html
<script type="module">
  import Norobot from 'https://cdn.jsdelivr.net/npm/@typebot.io/js@0.3/dist/web.js'
...
Norobot provides extensive theming options. **You can customize colors, fonts, button styles** and more directly within the Norobot interface. These changes automatically reflect in your Webflow integration.

<Image
  src="/blog-assets/add-chatbot-to-webflow/typebot-theme-settings.jpg"
  alt="Norobot Theme Settings"
  width={758}
  height={1872}
/>
### Advanced Interaction Options

Beyond opening the chatbot, Norobot offers other commands. You can programmatically:

- Send messages to the chatbot
- Close it
- Toggle its visibility based on user actions or page events
- [Integrate it in WhatsApp](./create-whatsapp-chatbot.mdx)

## How to Integrate an AI Chatbot like ChatGPT?

Norobot's integration allows you to incorporate advanced AI models like ChatGPT into your Webflow site. This powerful combination can transform user interactions by providing dynamic, intelligent responses to complex queries.

### Setting Up OpenAI Integration

To integrate an AI chatbot, use Norobot's **OpenAI block**. This feature creates chat completions based on user queries and displays AI-generated answers within your Norobot flow.

### Configuring the OpenAI Block

The OpenAI block in Norobot includes a message type called Dialogue. This feature allows you to pass a sequence of saved assistant and user message history to OpenAI, maintaining conversation context.

**Setup steps:**

1. Create a new OpenAI block in your Norobot flow.
...
1. Create an "Ask assistant" action in your Norobot flow.
...
<Info>
  ...
  check out the guide on [Norobot's
  blog](./train-chatbot-on-your-own-data.mdx). It covers the
...
Norobot offers various pre-built templates to streamline adding a chatbot to your Webflow site. These templates cater to various business needs and can easily be customized to match your brand's voice and goals.

### Marketing Templates

For lead generation, Norobot provides several marketing-oriented templates:
...
For unique use cases, Norobot offers templates like:
...
**With Norobot's versatile integration options, advanced AI capabilities, and ready-to-use templates**, you can quickly implement a chatbot tailored to your needs.
