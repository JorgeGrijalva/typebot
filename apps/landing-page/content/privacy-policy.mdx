...
## As a user of Norobot, the chatbot builder
...
- The payment process is handled by a third-party payment provider. If you choose to upgrade to a Norobot paid plan, the billing information and the payment process is handled by Stripe. See the Stripe [privacy policy](https://stripe.com/privacy) for full details.
...
We will also retain and use this information as necessary for the purposes set out in this policy and to the extent necessary to comply with our legal obligations, resolve disputes, enforce our agreements and protect Norobot’s legal rights.

You can ask to delete your Norobot account at any time by [contacting us](mailto:contact@typebot.io). All your data will be permanently deleted immediately.
