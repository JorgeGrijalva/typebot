...
description: "Learn how to add a chatbot to your WordPress site using Norobot"
postedAt: "2024-06-20"
author: younes
---
...
In this article, we'll look at it using Norobot. Norobot is a chatbot builder that lets you create advanced conversational apps visually, with no coding needed. It's time to change the way you interact with your audience, boost engagement, and increase conversions for your business.
...
Now, let's talk about **Norobot**, the chatbot builder that will simplify your life.

**Overview of Norobot’s Feature-Rich Platform**

Norobot is like a Swiss Army knife for chatbot builders, packed with useful features:

- **Drag-and-Drop Interface**: No coding needed! Use Norobot’s visual builder to create chatbots by dragging and dropping elements like text bubbles, input fields, and buttons.
...
Absolutely! Norobot is designed for non-technical users. If you can navigate WordPress, you can set up your chatbot. Installing it is as easy as adding a plugin and following simple steps.

## Step-by-Step Guide to Add Chatbot in WordPress Using Norobot

### Install and Activate Norobot Plugin

First, let's get the Norobot plugin onto your WordPress site. You can download it [here](https://wordpress.org/plugins/typebot/). Or from your Wordpress dashboard:
...
2. **Search for Norobot**: Type “Norobot” in the search bar. Click “Install Now” once you find the official Norobot plugin.
  ![How to look for Norobot in the WordPress Plugin Directory](/blog-assets/add-chatbot-to-wordpress/typebot-wordpress-plugin-directory.jpg)

3. **Activate the Plugin**: After installation, click the “Activate” button. Norobot will now appear in your WordPress menu.
  ![Activate Norobot Plugin](/blog-assets/add-chatbot-to-wordpress/wordpress-typebot-activate.jpg)
...
1. **Access Norobot Settings**: In the WordPress admin area, go to Settings > Norobot.
  ![Norobot Settings](/blog-assets/add-chatbot-to-wordpress/wordpress-typebot-settings.jpg)
2. **Log In to Your Norobot Account**: If you don’t have an account, create one now. After logging in, either create a new Norobot or open an existing one.
3. **Generate a Code Snippet**: Click on “Share” within Norobot. Select “WordPress” and click the "Get Code Snippet" button to generate your unique code.
  ![Generate Code Snippet](/blog-assets/add-chatbot-to-wordpress/typebot-share-wordpress.jpg)

4. **Paste the Code into WordPress**: Copy the snippet and paste it into the “Code Snippet” field in the Norobot settings on your WordPress site. Don’t forget to put ‘0.2’ in the Library version.
  ![Paste Code Snippet](/blog-assets/add-chatbot-to-wordpress/typebot-wordpress-filled-settings.jpg)

Now you’re set with the basics. But there’s more. Norobot offers extensive options for customization to make your chatbot exactly how you envision it.
...
**Using Norobot's Drag-and-Drop Interface**

Creating a chatbot should be as simple as dragging and dropping elements into place—like arranging pieces of a puzzle. That's precisely what Norobot offers. With its intuitive drag-and-drop interface, you can assemble your chatbot visually. **No coding, no headaches.** Just click and configure the building blocks to create a conversational flow that suits your needs.

**Adding Various Conversational Elements**

A one-note chatbot can be as engaging as a brick wall. To keep your visitors interested, you need variety. Norobot allows you to add:
...
- **Buttons and Quick Replies**: Enhance interactivity with buttons for users to make selections without typing.
  ![Norobot integrations](/blog-assets/chatfuel-alternatives/typebot-integrations.jpg)
...
Ever wished your chatbot could respond differently based on user input? With Norobot, it can. Using conditional logic, you can set up your chatbot to:

- Provide personalized responses.
- Redirect the user based on their choices.
- Trigger specific functions depending on the collected data.

Additionally, Norobot integrates with leading platforms like OpenAI and Google Sheets. Need to send data to a spreadsheet or fetch information from a webhook? Norobot covers all these needs.

## Embedding the Chatbot into Your WordPress Site

**Customizing the Chatbot’s Appearance to Match Your Site’s Theme**

The look and feel of your chatbot should blend seamlessly with your website’s aesthetic. Norobot offers easy theming options:
...
With a cohesive appearance, your chatbot will enhance user experience without feeling like an add-on. Go over the Theme tab to customize your Norobot. If you need help, you can check out [the documentation](https://docs.typebot.io/theme/overview).

**Can the Chatbot Be Embedded on Specific Pages Only?**

Absolutely! You can customize where your chatbot appears:

1. **Excluded Pages**: In the Norobot WordPress settings, use the “Excluded Pages” input to specify where you don’t want the chatbot to appear. For example:
...
You can use the Analytics section of the Norobot app to get all these data.
