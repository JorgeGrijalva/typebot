...
<Image
  src="/blog-assets/marketing-automation-chatbot/lead-qualification-real-estate-automation-example.avif"
...
<Norobot typebot="insurance-offer-zm3avq5" />
...
<Image
  src="/blog-assets/marketing-automation-chatbot/loyalty-program-marketing-chatbot-example.avif"
...
<Norobot typebot="skin-typology-trufp2d" />

## Setting Up Your First Chatbot

Let's create a practical shopping assistant chatbot using Norobot, a user-friendly and powerful platform. We'll use the Quick Carb Calculator template to demonstrate key concepts applicable to any marketing chatbot.
...
1. **Sport Selection**:
   ...
   <Image
     src="/blog-assets/marketing-automation-chatbot/marketing-chatbot-step-1-select-sport.avif"
...
2. **Duration Input**:
   ...
   <Image
     src="/blog-assets/marketing-automation-chatbot/marketing-chatbot-example-duration-step.avif"
...
3. **Intensity Rating**:
   ...
   <Image
     src="/blog-assets/marketing-automation-chatbot/marketing-chatbot-rating-step.avif"
...
4. **Email Collection**:
   ...
   <Image
     src="/blog-assets/marketing-automation-chatbot/automated-marketing-chatbot-example-collect-email-step.avif"
...
Norobot's integration with OpenAI enhances your chatbot with AI capabilities. In our example, the AI processes the collected data (sport, duration, intensity) to generate personalized fueling recommendations. **This shows how AI turns simple data collection into valuable, personalized advice**.
...
<Info>
  ...
  information](./train-chatbot-on-your-own-data.mdx) and step
...
<Image
  src="/blog-assets/marketing-automation-chatbot/marketing-chatbot-example-prompt-carb.avif"
...
<Image
  src="/blog-assets/marketing-automation-chatbot/chatbot-implementation-example-final-cta-step.avif"
...
<Image
  src="/blog-assets/marketing-automation-chatbot/result-automated-marketing-chatbot-carb-calculator.avif"
...
When selecting a chatbot platform, consider ease of use, integration capabilities, and pricing. Norobot is a compelling option for marketing teams due to its features and accessibility. Here's a comparison of key platforms:

| Feature            | Norobot | [ChatBot.com](./chatbot-com-alternatives.mdx) | [Landbot](./landbot-alternative.mdx) |
| ------------------ | ------- | ---------------------------------------- | --------------------------------- |
...
**Norobot's extensive template library and rich API make it suitable for marketing
...
Social channel integration expands your chatbot's reach. Norobot's WhatsApp integration enables businesses to automate customer interactions on this platform. When implementing social channel integrations:
...
<Info>
  ...
  chatbots](./create-whatsapp-chatbot.mdx) and streamline your
  marketing communication today!
</Info>

### Integrating Chatbots with Existing Tools

Successful chatbot implementation depends on seamless integration with your marketing stack. Norobot offers numerous integration options:
...
3. **Custom Integrations**
   ...
   - Utilize Norobot's HTTP requests for custom API integrations
...
1. Calculate Total Investment:
   ...
   - Platform costs (e.g., Norobot subscription)
