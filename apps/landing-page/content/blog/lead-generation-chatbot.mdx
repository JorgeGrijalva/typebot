...
description: "Discover how lead generation chatbots can revolutionize your business. Boost engagement, conversions, and sales with AI-powered chatbots. Learn best practices and see examples from top companies."
postedAt: "2024-04-22"
author: younes
---
...
## Step-by-Step Setup Guide Using Norobot

1. **Create a New Norobot**: First, sign up and log in to Norobot. From the dashboard, create a new chatbot.
    <Image
      src="/blog-assets/lead-generation-chatbot/create-new-typebot.png"
      alt="How to create a new Norobot"
      width="2000"
      height="1019"
    />

2. **Create a Welcome Message**: Use the Norobot builder to design your conversation
   flow. Start with an engaging greeting to welcome users.
    <Image
      src="/blog-assets/lead-generation-chatbot/create-welcome-message.gif"
      alt="How to create a welcome message in Norobot"
      width="800"
      height="631"
    />
...
3. **Ask for Email**: Craft a series of questions to capture useful information from your leads. Important among these should be asking for their email address.
    <Image
      src="/blog-assets/lead-generation-chatbot/ask-for-email.gif"
      alt="How to ask for an email in Norobot"
      width="800"
      height="631"
    />
...
4. **Send to Google Sheets**: Integrate your chatbot with Google Sheets. This allows
   ...
   lead data current.
    <Image
      src="/blog-assets/lead-generation-chatbot/send-to-google-sheets.png"
      alt="How to send a response in a Google Sheets in Norobot"
      width="2000"
      height="857"
    />
...
Start boosting your sales today by creating your own lead generation with our [chatbot builder for lead generation](/).
...
<Image
  src="/blog-assets/lead-generation-chatbot/example-custom-chatbot.png"
...
<Image
  src="/blog-assets/lead-generation-chatbot/drift-chatbot-example.png"
...
<Image
  src="/blog-assets/lead-generation-chatbot/pendo-chatbot-example.png"
...
<Image
  src="/blog-assets/lead-generation-chatbot/intercom-chatbot-example.png"
...
<Image
  src="/blog-assets/lead-generation-chatbot/geico-chatbot-example.png"
